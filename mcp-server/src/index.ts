...
server.registerTool(
  ...
  async (args) => handleCelContext(cel, args)
);

// Tool 2: Execute actions
server.registerTool(
  "cel_action",
  {
    title: "CEL Action",
  ...
  async (args) => handleCelAction(cel, args)
);

// Tool 3: Knowledge store
server.registerTool(
  "cel_knowledge",
  {
    title: "CEL Knowledge",
  ...
  async (args) => handleCelKnowledge(cel, args)
);

// Tool 4: Observe state changes
server.registerTool(
  "cel_observe",
  {
    title: "CEL Observe",
  ...
  async (args) => handleCelObserve(cel, args)
);
